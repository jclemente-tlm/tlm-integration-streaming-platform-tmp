...
TEMPLATE_FILES=(
    "./templates/connectors/source/oracle/source_cdc_talmabd_LIM_W1_HL.json"
    "./templates/connectors/source/oracle/source_cdc_talmabd_PE_SHARE_HL.json"
    "./templates/connectors/source/oracle/source_cdc_talmaop_TLMIMPO.json"
    "./templates/connectors/source/oracle/source_cdc_talmaop_TLMIMPO_VENTAS_SAP.json"
    "./templates/connectors/source/oracle/source_cdc_talmaop_TLMSHANABI.json"
    "./templates/connectors/source/oracle/source_cdc_talmaop_TLMTRADU_ADU_LAGI_SIOP_RESUMEN.json"
    "./templates/connectors/source/oracle/source_cdc_talmaop_TLMADMIN.json"
)
...
for TEMPLATE_FILE in "${TEMPLATE_FILES[@]}"; do
    ...
    export DB_TALMAOP_HOST
    export DB_TALMAOP_PORT
    export DB_TALMAOP_USER
    export DB_TALMAOP_PASSWORD
    export DB_TALMAOP_DBNAME
    export BROKER_1_IP
    export BROKER_2_IP
